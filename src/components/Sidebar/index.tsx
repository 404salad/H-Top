    ...
    >
      ...
      <div className=" flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          {/* <Image
            ...
            priority
          /> */}
          <p className="text-white text-5xl">H-Top</p>
        </Link>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
               <li>
                  {/*TODO: change this to the vercel url instead of localhost if we host*/ }
       ...
       <li>
                ...
                >
<svg width="20x" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" mirror-in-rtl="true" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="#f6f5f4" d="M19 17c-1.1 0-2-.9-2-2v-1c0-1.1.9-2 2-2s2 .9 2 2v1c0 1.1-.9 2-2 2zm-2 6.993L21 24c.55 0 1-.45 1-1v-2c0-1.65-1.35-3-3-3s-3 1.35-3 3v2c0 .552.448.993 1 .993z"></path> <path fill="#f6f5f4" d="M20 2v7c0 .55-.45 1-1 1s-1-.45-1-1V2.5c0-.28-.22-.5-.5-.5h-13c-.28 0-.5.22-.5.5v19c0 .28.22.5.5.5H13c.55 0 1 .45 1 1s-.45 1-1 1H4c-1.1 0-2-.9-2-2V2c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2z"></path> <path fill="#f6f5f4" d="M10.707 4.293c-.39-.39-1.023-.39-1.414 0L8 5.586l-.293-.293c-.39-.39-1.023-.39-1.414 0s-.39 1.023 0 1.414l1 1c.195.195.45.293.707.293s.512-.098.707-.293l2-2c.39-.39.39-1.023 0-1.414zm0 6c-.39-.39-1.023-.39-1.414 0L8 11.586l-.293-.293c-.39-.39-1.023-.39-1.414 0s-.39 1.023 0 1.414l1 1c.195.195.45.293.707.293s.512-.098.707-.293l2-2c.39-.39.39-1.023 0-1.414zm0 6c-.39-.39-1.023-.39-1.414 0L8 17.586l-.293-.293c-.39-.39-1.023-.39-1.414 0s-.39 1.023 0 1.414l1 1c.195.195.45.293.707.293s.512-.098.707-.293l2-2c.39-.39.39-1.023 0-1.414z"></path> </g></svg>                 
                  Attendance
                </Link>
              </li>
              {/* <!-- Menu Item Attendance --> */}
